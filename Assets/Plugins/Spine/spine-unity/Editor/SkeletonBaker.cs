...
public static class SkeletonBaker
{
...
#else
                    controller.AddClipToAnimatorController(clip);
#endif
                }
            }
    ...
    private static Bone extractionBone;
    private static Slot extractionSlot;

    private static Bone GetExtractionBone()
    {
    ...
    private static Slot GetExtractionSlot()
    {
    ...
    private static Material ExtractMaterial(Attachment attachment)
    {
    ...
    private static Mesh ExtractRegionAttachment(string name, RegionAttachment attachment, Mesh mesh = null)
    {
    ...
    private static Mesh ExtractMeshAttachment(string name, MeshAttachment attachment, Mesh mesh = null)
    {
    ...
    private static Mesh ExtractSkinnedMeshAttachment(string name, SkinnedMeshAttachment attachment, int slotIndex, SkeletonData skeletonData, List<Transform> boneList, Mesh mesh = null)
    {
    ...
    private static Vector2[] ExtractUV(float[] floats)
    {
    ...
    private static Vector3[] ExtractVerts(float[] floats)
    {
    ...
    private static AnimationClip ExtractAnimation(string name, SkeletonData skeletonData, Dictionary<int, List<string>> slotLookup, bool bakeIK, SendMessageOptions eventOptions, AnimationClip clip = null)
    {
    ...
    private static float GetUninheritedRotation(Bone b)
    {
    ...
    private static void BakeBone(Bone bone, Spine.Animation animation, AnimationClip clip)
    {
